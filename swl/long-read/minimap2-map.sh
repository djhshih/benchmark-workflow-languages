...
set -e
minimap2 -a -x ${preset} -t ${cpu} -y -R "@RG\tID:${sample_name}\tSM:${sample_name}\tPL:${platform}" ${reference_fasta} ${reads} | samtools sort --threads 2 -m 1G -o ${sample_name}.sorted.bam -
